...
urlpatterns = [
    ...
    url('plot/', include('plot_dashboard.urls', namespace='plot')),
    url('household/', include('household_dashboard.urls')),
    url('member/', include('member_dashboard.urls', namespace='member')),
    url('enumeration/', include('enumeration.urls')),
    url('subject/', include('bcpp_subject_dashboard.urls', namespace='bcpp_subject')),
