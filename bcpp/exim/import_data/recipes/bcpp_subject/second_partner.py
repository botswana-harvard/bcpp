...
m2m_recipes = [
    M2mRecipe(
        ...
        data_model_name='bcpp_subject.secondpartner',
        old_data_model_app_label='bcpp_subject',
        old_data_model_model_name='monthssecondpartner',
...
site_recipes.register(ModelRecipe(
    model_name='bcpp_subject.secondpartner',
    old_model_name='bcpp_subject.monthssecondpartner',
