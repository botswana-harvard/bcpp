...
class SubjectCommunityListFilter(SimpleListFilter):
    ...
    def lookups(self, request, model_admin):
        communities = []
        querystr = 'subject_visit__household_member__household_structure__household__plot__community'
    ...
    def queryset(self, request, queryset):
        if self.value():
            return queryset.filter(
                subject_visit__household_member__household_structure__household__plot__community=self.value())
